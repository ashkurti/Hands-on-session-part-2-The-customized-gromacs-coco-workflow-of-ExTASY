...
_KERNEL_INFO = {
    ...
    "name":         "tleap",        #md.tleap is the one already supported by EnMD hence name is just tleap
    ...
    "arguments":   {
                    ...
                    "--basename=":
                        {
                            "mandatory": True,
                            "description": "Basename of all the .pdb files"
                        },
                    "--cycle=":
                        {
                            "mandatory": True,
...
class tleap_Kernel(KernelBase):
    ...
    def __init__(self):
        """Le constructor.
        """
        super(tleap_Kernel, self).__init__(_KERNEL_INFO)
    ...
    def _bind_to_resource(self, resource_key):
        ...
        arguments = ['postprocessing.py',  '{0}'.format(self.get_arg("--basename=")),
                                                                    '{0}'.format(self.get_arg("--numofsims=")),
